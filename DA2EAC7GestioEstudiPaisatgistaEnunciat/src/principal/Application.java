       ...
       do{
            ...
            switch (opcio) { 
                ...
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("\nQuin dissenyador vols modificar? introdueix el nif.");
                    //////////////////////////////////////////////////////
                    /////La siguiente linea sirve para solucionar un bug//
                    //////////////////////////////////////////////////////
                    String nif1 = DADES.nextLine();
                    //Esta siguiente es la buena
          1
                  String dni = DADES.nextLine();
                    
                    indexSel = estudiActual.selectDissenyador(dni);
                    if (indexSel >= 0) {
                        dissenyadors[indexSel].updateDissenyador();
                    } else {
        ...
        do{
            ...
            switch (opcio) { 
                ...
                case 2:
                    ...
                    indexSel = estudiActual.selectJardiner(nif);
                    if(indexSel>=-1){
        ...
        do{
            ...
            switch (opcio) { 
                ...
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Introdueix el codi del torn: ");
                    //////////////////////////////////////////////////////
                    /////La siguiente linea sirve para solucionar un bug//
                    //////////////////////////////////////////////////////
                    String codi1 = DADES.nextLine();
                    //Esta siguiente es la buena
                    String codi = DADES.nextLine();
                    int pos = estudiActual.selectTorn(codi);
                    if(pos!=-1){
                        torns[pos].updateTorn();
                    }         
                    break;
                case 3:
        ...
        do{
            ...
            switch (opcio) { 
                ...
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Introdueix el codi del projecte: ");
                    int codi = DADES.nextInt();
                    int pos = estudiActual.selectProjecte(codi);
                    if(pos!=-1){
                        projectes[pos].updateProjecte();
                    } else{
